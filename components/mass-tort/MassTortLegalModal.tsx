...
export default function MassTortLegalModal({
  ...
  return (
    <div
      id={id}
      className="modal landbot-modal fixed inset-0 z-[100] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm"
      aria-hidden={!isOpen}
      onClick={onClose}
    >
      <div
        ...
        className="modal-dialog modal-dialog-centered modal-dialog-scrollable w-full max-w-[1000px]"
      ...
      >
        <div className="modal-content flex max-h-[90vh] flex-col overflow-hidden border-0 bg-white shadow-2xl">
          <div className="modal-header flex items-center justify-between border-b border-gray-200 px-6 py-5">
            <span id={`${id}-label`} className="modal-title h4 text-2xl font-semibold text-[#1c302a]">
              {title}
            </span>
            ...
            <button
              type="button"
              onClick={onClose}
              className="btn-close text-gray-500 transition-colors hover:text-black"
              aria-label="Close"
            >
          ...
          <div className="modal-footer flex justify-end border-t border-gray-200 px-6 py-5">
            <button
              type="button"
              onClick={onClose}
              className="btn btn-secondary border border-[#c5e68b] bg-[#d9f99d] px-8 py-2 text-sm font-bold uppercase text-[#1c302a] transition-colors hover:bg-[#c5e68b]"
            >
              Close
            </button>
          </div>
