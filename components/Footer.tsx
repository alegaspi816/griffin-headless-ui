              ...
              <ul className="space-y-4 text-sm">
                <li className="flex items-start gap-3">
                  <span className="footer-icon-cont flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="28" height="28" className="fill-current"><path d="M160 252.6C160 166.6 231.1 96 320 96C408.9 96 480 166.6 480 252.6C480 302.9 454.1 362 418.6 418.2C384.6 472 344.6 518.7 320 545.6C295.4 518.7 255.4 471.9 221.4 418.2C185.9 362 160 302.9 160 252.6zM320 64C214 64 128 148.4 128 252.6C128 371.9 248.2 514.9 298.4 569.4C310.2 582.2 329.8 582.2 341.6 569.4C391.8 514.9 512 371.9 512 252.6C512 148.4 426 64 320 64zM368 256C368 282.5 346.5 304 320 304C293.5 304 272 282.5 272 256C272 229.5 293.5 208 320 208C346.5 208 368 229.5 368 256zM320 176C275.8 176 240 211.8 240 256C240 300.2 275.8 336 320 336C364.2 336 400 300.2 400 256C400 211.8 364.2 176 320 176z" /></svg>
                  </span>

                  <a href="https://maps.app.goo.gl/5EjPcV9Uw17iH6JX9" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">1120 S Dobson Rd, Suite 230 <br />Chandler, AZ 85286</a>
                </li>
      ...
      <div className="footer-bottom border-t border-gray-800">
       <div className="pt-6 pb-6 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center sm:flex sm:justify-between sm:text-left items-center">
            ...
            <p className="mt-4 text-xs sm:order-first sm:mt-0">© Copyrights {currentYear}. Griffin Law, PLC</p>
          </div>
        </div>
      </div>
